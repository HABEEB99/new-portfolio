...
const Header: React.FC<HeaderProps> = () => {
	...
	return (
		<header className="h-[10vh] fixed top-0 w-full z-10 flex items-center justify-between px-4 md:px-12 lg:px-32 shadow-xl">
			<Link href="/" passHref>
			...
			<ul className="hidden lg:flex items-center space-x-6">
				<NavItem title="Home" Icon={AiFillHome} path="/" />
				<NavItem title="About" Icon={BsInfoLg} path="#about" />
				<NavItem
					title="Project"
					Icon={GiAmericanFootballHelmet}
					path="#project"
				/>
				<NavItem title="Skills" Icon={FaTools} path="#skills" />
				<NavItem title="Experience" Icon={BsBriefcaseFill} path="#experience" />
			</ul>
